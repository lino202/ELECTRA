...
double orient3d(double *pa, double *pb, double *pc, double *pd)
{
  ...
  permanent = (std::fabs(bdxcdy) + std::fabs(cdxbdy)) * std::fabs(adz)
...
double incircleadapt(double *pa, double *pb, double *pc, double *pd, double permanent)
{
  ...
  errbound = iccerrboundC * permanent + resulterrbound * std::fabs(det);
...
double insphereexact(double *pa, double *pb, double *pc, double *pd, double *pe)
{
  ...
  TwoProduct(pd[0], pe[1], dxey1, dxey0);
  TwoProduct(pe[0], pd[1], exdy1, exdy0);
  Two_Two_Diff(dxey1, dxey0, exdy1, exdy0, de[3], de[2], de[1], de[0]);

  TwoProduct(pe[0], pa[1], exay1, exay0);
  TwoProduct(pa[0], pe[1], axey1, axey0);
  ...
  TwoProduct(pc[0], pe[1], cxey1, cxey0);
  TwoProduct(pe[0], pc[1], excy1, excy0);
  ...
  TwoProduct(pe[0], pb[1], exby1, exby0);
  TwoProduct(pb[0], pe[1], bxey1, bxey0);
...
double insphereslow(double *pa, double *pb, double *pc, double *pd, double *pe)
{
  ...
  TwoDiff(pa[0], pe[0], aex, aextail);
  TwoDiff(pa[1], pe[1], aey, aeytail);
  TwoDiff(pa[2], pe[2], aez, aeztail);
  TwoDiff(pb[0], pe[0], bex, bextail);
  TwoDiff(pb[1], pe[1], bey, beytail);
  TwoDiff(pb[2], pe[2], bez, beztail);
  TwoDiff(pc[0], pe[0], cex, cextail);
  TwoDiff(pc[1], pe[1], cey, ceytail);
  TwoDiff(pc[2], pe[2], cez, ceztail);
  TwoDiff(pd[0], pe[0], dex, dextail);
  TwoDiff(pd[1], pe[1], dey, deytail);
  TwoDiff(pd[2], pe[2], dez, deztail);
...
double insphereadapt(double *pa, double *pb, double *pc, double *pd, double *pe,
                   double permanent)
{
   double aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
  double det, errbound;
  ...
  TwoProduct(aex, bey, aexbey1, aexbey0);
  TwoProduct(bex, aey, bexaey1, bexaey0);
  Two_Two_Diff(aexbey1, aexbey0, bexaey1, bexaey0, ab3, ab[2], ab[1], ab[0]);
  ab[3] = ab3;

  TwoProduct(bex, cey, bexcey1, bexcey0);
  TwoProduct(cex, bey, cexbey1, cexbey0);
  Two_Two_Diff(bexcey1, bexcey0, cexbey1, cexbey0, bc3, bc[2], bc[1], bc[0]);
  bc[3] = bc3;

  TwoProduct(cex, dey, cexdey1, cexdey0);
  TwoProduct(dex, cey, dexcey1, dexcey0);
  Two_Two_Diff(cexdey1, cexdey0, dexcey1, dexcey0, cd3, cd[2], cd[1], cd[0]);
  cd[3] = cd3;

  TwoProduct(dex, aey, dexaey1, dexaey0);
  TwoProduct(aex, dey, aexdey1, aexdey0);
  Two_Two_Diff(dexaey1, dexaey0, aexdey1, aexdey0, da3, da[2], da[1], da[0]);
  da[3] = da3;

  TwoProduct(aex, cey, aexcey1, aexcey0);
  TwoProduct(cex, aey, cexaey1, cexaey0);
  Two_Two_Diff(aexcey1, aexcey0, cexaey1, cexaey0, ac3, ac[2], ac[1], ac[0]);
  ac[3] = ac3;

  TwoProduct(bex, dey, bexdey1, bexdey0);
  TwoProduct(dex, bey, dexbey1, dexbey0);
  ...
  TwoDiffTail(pa[0], pe[0], aex, aextail);
  TwoDiffTail(pa[1], pe[1], aey, aeytail);
  TwoDiffTail(pa[2], pe[2], aez, aeztail);
  TwoDiffTail(pb[0], pe[0], bex, bextail);
  TwoDiffTail(pb[1], pe[1], bey, beytail);
  TwoDiffTail(pb[2], pe[2], bez, beztail);
  TwoDiffTail(pc[0], pe[0], cex, cextail);
  TwoDiffTail(pc[1], pe[1], cey, ceytail);
  TwoDiffTail(pc[2], pe[2], cez, ceztail);
  TwoDiffTail(pd[0], pe[0], dex, dextail);
  TwoDiffTail(pd[1], pe[1], dey, deytail);
  TwoDiffTail(pd[2], pe[2], dez, deztail);
  ...
  errbound = isperrboundC * permanent + resulterrbound * std::fabs(det);
...
double insphere(double *pa, double *pb, double *pc, double *pd, double *pe)
{
  ...
  aezplus = std::fabs(aez);
  bezplus = std::fabs(bez);
  cezplus = std::fabs(cez);
  dezplus = std::fabs(dez);
  aexbeyplus = std::fabs(aexbey);
  bexaeyplus = std::fabs(bexaey);
  bexceyplus = std::fabs(bexcey);
  cexbeyplus = std::fabs(cexbey);
  cexdeyplus = std::fabs(cexdey);
  dexceyplus = std::fabs(dexcey);
  dexaeyplus = std::fabs(dexaey);
  aexdeyplus = std::fabs(aexdey);
  aexceyplus = std::fabs(aexcey);
  cexaeyplus = std::fabs(cexaey);
  bexdeyplus = std::fabs(bexdey);
  dexbeyplus = std::fabs(dexbey);
                   ...
                   double eheight)
{
  ...
  int alen, blen, clen, dlen, elen;
  double abdet[384], cddet[384], cdedet[576];
  int ablen, cdlen;
  double deter[960];
  int deterlen;
  int i;
...
static
double orient4dadapt(double* pa, double* pb, double* pc, double* pd, double* pe,
                   double aheight, double bheight, double cheight, double dheight, 
                   double eheight, double permanent)
{
   double aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
   double aeheight, beheight, ceheight, deheight;
  double det, errbound;
  ...
  double aeytail, beytail, ceytail, deytail;
  double aeztail, beztail, ceztail, deztail;
  double aeheighttail, beheighttail, ceheighttail, deheighttail;
  ...
  cez = (double) (pc[2] - pe[2]);
  dez = (double) (pd[2] - pe[2]);
  aeheight = (double) (aheight - eheight);
  beheight = (double) (bheight - eheight);
  ceheight = (double) (cheight - eheight);
  deheight = (double) (dheight - eheight);
  ...
  TwoDiffTail(pa[1], pe[1], aey, aeytail);
  TwoDiffTail(pa[2], pe[2], aez, aeztail);
  TwoDiffTail(aheight, eheight, aeheight, aeheighttail);
  TwoDiffTail(pb[0], pe[0], bex, bextail);
  TwoDiffTail(pb[1], pe[1], bey, beytail);
  TwoDiffTail(pb[2], pe[2], bez, beztail);
  TwoDiffTail(bheight, eheight, beheight, beheighttail);
  TwoDiffTail(pc[0], pe[0], cex, cextail);
  TwoDiffTail(pc[1], pe[1], cey, ceytail);
  TwoDiffTail(pc[2], pe[2], cez, ceztail);
  TwoDiffTail(cheight, eheight, ceheight, ceheighttail);
  TwoDiffTail(pd[0], pe[0], dex, dextail);
  TwoDiffTail(pd[1], pe[1], dey, deytail);
  TwoDiffTail(pd[2], pe[2], dez, deztail);
  TwoDiffTail(dheight, eheight, deheight, deheighttail);
  if ((aextail == 0.0) && (aeytail == 0.0) && (aeztail == 0.0)
      && (bextail == 0.0) && (beytail == 0.0) && (beztail == 0.0)
      && (cextail == 0.0) && (ceytail == 0.0) && (ceztail == 0.0)
      && (dextail == 0.0) && (deytail == 0.0) && (deztail == 0.0)
