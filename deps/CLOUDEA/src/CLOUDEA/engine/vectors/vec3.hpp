...
#ifndef CLOUDEA_VECTORS_VEC3_HPP_
#define CLOUDEA_VECTORS_VEC3_HPP_
...
public:
    ...
    */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The coefficient-wise multiplication product.
     */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The coefficient-wise division product.
     */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] This vector with absolute values at its coefficients.
     */
    ...
    */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The Vec3 vector containing the data of vec.
     */
    ...
    /*!
       ...
       \return [CLOUDEA::Vec3<DATATYPE>] The Vec3 vector containing the result from the additive assignment.
    */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The Vec3 vector containing the result from the subtracting assignment.
     */
    Vec3<DATATYPE> & operator -= (const Vec3<DATATYPE> &v);
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The resulting Vec3 vector from the subtraction.
     */
     ...
     * \return [CLOUDEA::Vec3<DATATYPE>] The resulting Vec3 vector from the division.
     */
    Vec3<DATATYPE> operator /= (const DATATYPE &scalar);
...
#include "CLOUDEA/engine/vectors/vec3.tpp"

#endif //CLOUDEA_VECTORS_VEC3_HPP_
