...
#ifndef CLOUDEA_MODELS_WEAK_MODEL_3D_HPP_
#define CLOUDEA_MODELS_WEAK_MODEL_3D_HPP_
...
#include "CLOUDEA/engine/grid/grid_3d.hpp"
...
public:
     ...
     * \return [void]
     */
    void CreateIntegrationPoints(const IntegOptions &options, const InfSupportDomain &support_dom);

    void LoadIntegrationPoints(const std::string &ip_file);

    void CreateIntegrationPoints2(short num_per_elem);
    ...
    void ComputeMass(const std::vector<double> &density, const std::vector<double> &time_steps, const double &max_time_step,
                     const std::vector<std::vector<int> > &support_nodes_ids, bool scaling=false);
    ...
    inline TetraMesh & TetrahedralMesh() { return this->tetramesh_; }
     ...
     */
    inline const IntegPoints & IntegrationPoints() const { return this->integ_points_; }
...
#endif //CLOUDEA_MODELS_WEAK_MODEL_3D_HPP_
