...
#ifndef CLOUDEA_SOLVERS_DYN_RELAX_PROP_HPP_
#define CLOUDEA_SOLVERS_DYN_RELAX_PROP_HPP_
...
public:
     ...
     * \return [void]
     */
    void ComputeEquilibriumStepsNum(const double &solver_time_step);
...
#endif //CLOUDEA_SOLVERS_DYN_RELAX_PROP_HPP_
