...
#ifndef CLOUDEA_MESH_IO_ABAQUS_IO_TPP_
#define CLOUDEA_MESH_IO_ABAQUS_IO_TPP_
...
void AbaqusIO::SaveMesh(const MESHTYPE &mesh, const std::string &mesh_filename)
{
    ...
    out << "*Heading\n";
    out << "** Job name: CLOUDEA-mesh-job Model name: Model-1\n";
    out << "** Generated by: CLOUDEA, echo=NO, model=NO, history=NO, contact=NO\n";
    out << "**\n";
    out << "** PARTS\n";
    out << "**\n";
    ...
    case CLOUDEA::MeshType::tetrahedral :
...
#endif //CLOUDEA_MESH_IO_ABAQUS_IO_TPP_
