...
#ifndef CLOUDEA_MESH_IO_ABAQUS_IO_HPP_
#define CLOUDEA_MESH_IO_ABAQUS_IO_HPP_
...
private:
    ...
    //CLOUDEA::MeshType input_mesh_type_;                  /*!< The type of the parsed mesh. */
...
#include "CLOUDEA/engine/mesh_io/abaqus_io.tpp"

#endif // CLOUDEA_MESH_IO_ABAQUS_IO_HPP_
