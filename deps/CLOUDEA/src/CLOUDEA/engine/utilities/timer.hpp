...
#ifndef CLOUDEA_UTILITIES_TIMER_HPP_
#define CLOUDEA_UTILITIES_TIMER_HPP_
...
/*!
 * \class Timer
 * \brief Class implemmenting a timer for profiling of CLOUDEA.
 */
...
#endif //CLOUDEA_UTILITIES_EXPLICIT_SIM_TIMER_HPP_
