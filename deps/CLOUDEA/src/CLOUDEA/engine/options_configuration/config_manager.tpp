...
#ifndef CLOUDEA_OPTIONS_CONFIGURATION_CONFIG_MANAGER_TPP_
#define CLOUDEA_OPTIONS_CONFIGURATION_CONFIG_MANAGER_TPP_
...
DATATYPE ConfigManager::RetrieveArgument(const std::string &argument)
{
    if (!var_map_.count(argument)) {
        std::string error = "[CLOUDEA ERROR] Cannot retrieve configuration argument: " + argument;
...
#endif //CLOUDEA_OPTIONS_CONFIGURATION_CONFIG_MANAGER_TPP_
