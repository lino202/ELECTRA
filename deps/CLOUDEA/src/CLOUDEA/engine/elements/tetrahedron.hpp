...
#ifndef CLOUDEA_ELEMENTS_TETRAHEDRON_HPP_
#define CLOUDEA_ELEMENTS_TETRAHEDRON_HPP_
...
public:
     ...
     * \return [void]
     */
    void SetConnectivity(const int &n1, const int &n2,
     ...
     */
    inline const int & N1() const { return this->n1_; }
     ...
     */
    inline const int & N2() const { return this->n2_; }
     ...
     */
    inline const int & N3() const { return this->n3_; }
     ...
     */
    inline const int & N4() const { return this->n4_; }
     ...
     */
    inline const CLOUDEA::ElementType & ElementType() const { return this->element_type_; }
...
private:
    int id_;                            /*!< The id of the tetrahedron in a list of tetrahedra. */

    int n1_;                            /*!< The number of the first node of the tetrahedron. */

    int n2_;                            /*!< The number of the second node of the tetrahedron. */

    int n3_;                            /*!< The number of the third node of the tetrahedron. */

    int n4_;                            /*!< The number of the fourth node of the tetrahedron. */
    ...
    CLOUDEA::ElementType element_type_;     /*!< The element type of the tetrahedron is set during construction. */
};
...
#endif // CLOUDEA_ELEMENTS_TETRAHEDRON_HPP_
