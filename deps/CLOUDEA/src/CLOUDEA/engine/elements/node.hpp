...
#ifndef CLOUDEA_ELEMENTS_NODE_HPP_
#define CLOUDEA_ELEMENTS_NODE_HPP_
...
private:
    ...
    CLOUDEA::ElementType element_type_;     /*!< The node's element type is set during construction. */
...
#endif //CLOUDEA_ELEMENTS_NODE_HPP_
