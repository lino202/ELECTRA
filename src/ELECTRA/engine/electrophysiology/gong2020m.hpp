...
/**
   \file gong2020m.hpp
   \brief Gong2020m class header file.
   \author Konstantinos A. Mountris
   \date 22/12/2020
*/

#ifndef ELECTRA_ELECTROPHYSIOLOGY_MODELS_GONG2020M_HPP_
#define ELECTRA_ELECTROPHYSIOLOGY_MODELS_GONG2020M_HPP_
 ...
 * \class Gong2020m
 * \author Konstantinos A. Mountris
 * \brief  Gong et al 2020, human cardiac ventricular action potential model with \beta-adrenergic singaling \cite gong2020 and modified INa current gates from TenTusscher 2006 model.
 */

class Gong2020m : public EpBasic
{
protected:
...
public:
    ...
    /**
     * \brief The default constructor of the Gong2020m class.
     */
    Gong2020m();


    /**
     * \brief The default destructor of the Gong2020m class.
     */
    virtual ~Gong2020m();


    /**
     * \brief Initialize the variables and parameters of the Gong2020m cell model.
     * \return [void]
     */
    ...
    /**
     * \brief Compute the temporal update of the Gong2020m cell model.
     * \return [void]
     */
     ...
     * \return [void]
     */
    virtual void SetV(double v) { this->var_[Gng20mVar::v] = v; }
    ...
    */
     ...
     */
    inline virtual double V() const { return this->var_[Gng20mVar::v]; }
     ...
     */
    inline virtual double dVdt() const { return this->var_[Gng20mVar::dvdt]; }
     ...
     */
    inline double Iion() const { return this->cur_[Gng20mCur::Iion]; }
...
#endif // ELECTRA_ELECTROPHYSIOLOGY_MODELS_GONG2020M_HPP_